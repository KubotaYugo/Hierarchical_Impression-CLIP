...
# 保存用フォルダの準備 
SAVE_FOLDER = "Impression-CLIP/experiment2"
...
parameters = list(font_encoder.parameters())+list(clip_model.parameters())+list(emb_i.parameters())+list(emb_t.parameters())+list(temp.parameters())
