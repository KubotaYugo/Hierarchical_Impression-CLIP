...
# 特徴量の抽出
embedded_img_features, embedded_tag_features = eval_utils.extract_features(font_encoder, clip_model, dataloader)
embedded_single_tag_features = eval_utils.extract_text_features(tagloader, clip_model)
