...
# BASE_PATH の定義
BASE_PATH="programs/Hierarchical_Impression-CLIP/experiment5/experiment5-1/clustering"
...
# コマンド: bash programs/Hierarchical_Impression-CLIP/experiment5/experiment5-1/clustering/clustering.sh