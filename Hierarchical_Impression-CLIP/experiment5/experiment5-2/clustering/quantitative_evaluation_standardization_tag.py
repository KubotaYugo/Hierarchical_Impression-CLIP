...
SAVE_DIR = f'{EXP}/quantitative_evaluation_standardization_tag'
...
for NUMBER_OF_CLUSTERS in range(2, NUMBER_OF_CLUSTERS_MAX+1): 
    ...
    # get labels
    labels = np.load(f'{EXP}/clustering_standardized_tag/{DATASET}/{NUMBER_OF_CLUSTERS}.npz')["arr_0"].astype(np.int16)
    # calculate scores
