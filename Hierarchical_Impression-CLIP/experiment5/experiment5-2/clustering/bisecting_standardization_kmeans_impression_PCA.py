...
EXP = utils.EXP
DATASET = 'train'
SAVE_DIR = f'{EXP}/clustering/cluster_visualization_standardization/PCA/{DATASET}'
...
plt.savefig(f'{SAVE_DIR}/impression_cluster_before_embedding.png', bbox_inches='tight', dpi=500)
plt.close()
