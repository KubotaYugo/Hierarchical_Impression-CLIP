...
EXP = 'Hierarchical_Impression-CLIP/experiment5/experiment5-2'
IMG_CLUSTER_PATH = f'{EXP}/clustering_standardized_img/train/50.npz'
TAG_CLUSTER_PATH = f'{EXP}/clustering_standardized_tag/train/50.npz'
