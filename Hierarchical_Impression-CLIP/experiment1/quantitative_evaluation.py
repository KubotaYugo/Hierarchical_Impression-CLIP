...
ARR_img2tag = eval_utils.retrieval_rank(similarity_matrix, "img2tag")
ARR_tag2img = eval_utils.retrieval_rank(similarity_matrix, "tag2img")
print(f"ARR_img2tag: {np.mean(ARR_img2tag):.1f}")
print(f"ARR_tag2img: {np.mean(ARR_tag2img):.1f}")
