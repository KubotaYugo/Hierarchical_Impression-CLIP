...
SAVE_DIR = f'{EXP}/LR={LR}, BS={BATCH_SIZE}/similarity_hist_hierarchical'
...
img_hierarchy = np.load(IMG_HIERARCHY_PATH)["arr_0"].astype(int)
tag_hierarchy = np.load(TAG_HIERARCHY_PATH)["arr_0"].astype(int)
