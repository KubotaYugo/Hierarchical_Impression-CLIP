...
def main(config=None):
    with wandb.init(config=config):
        ...
        NARROW_DOWN_INSTANCES = config.narrow_down_instances
        LR = config.lr
        ...
        # make save directory
        SAVE_DIR = f'{EXP}/LR={LR}_BS={BATCH_SIZE}_{LOSS_TYPE}_{NARROW_DOWN_INSTANCES}/results'
        ...
        for epoch in range(1, MAX_EPOCH + 1):
            ...
            loss, total_itr = train(trainloader, models, criterion1, criterion2, optimizer, total_itr, SAVE_DIR)
        ...
        wandb.log({"meanARR_val_min":meanARR_best}, step=total_itr)
...
if __name__ == '__main__':
    ...
    sweep_id = wandb.sweep(sweep=sweep_configuration, project='Hierarchical_ImpressionCLIP_3-4')
