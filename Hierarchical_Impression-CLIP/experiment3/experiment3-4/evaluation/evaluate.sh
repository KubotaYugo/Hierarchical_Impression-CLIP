...
# BASE_PATH の定義
BASE_PATH="programs/Hierarchical_Impression-CLIP/experiment3/experiment3-4/evaluation"
...
# コマンド: bash programs/Hierarchical_Impression-CLIP/experiment3/experiment3-4/evaluation/evaluate.sh