...
import math
import argparse
from generate_dataset import DatasetCategory
from hierarchical_dataset import DeepFashionHierarchihcalDatasetEval
...
from util import adjust_learning_rate, warmup_learning_rate, set_optimizer
import time
import sys
import shutil
...
def set_model(args):
    ...
    classifier = resnet_modified.LinearClassifier(name='resnet50', num_classes=args.num_classes)
