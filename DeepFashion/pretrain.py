...
from hierarchical_dataset import DeepFashionHierarchihcalDataset, HierarchicalBatchSampler
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # args.classifier = resnet_modified.LinearClassifier(name=args.model, num_classes=args.num_classes).cuda(args.gpu)
